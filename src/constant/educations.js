export const educations = [
  {
    ...
    description: "Lead development of modern web applications with React, Node.js and TypeScript. Management of a team of 4 developers.",
  ...
  },
  {
    ...
    description: "Creation of responsive and accessible user interfaces. Performance and user experience optimization.",
    skills: ["React", "Vue.js", "Sass", "Jest", "Webpack"]
  },
  {
    year: "2019 - 2021",
    title: "Junior Web Developer",
    company: "Innovative Startup",
    description: "Feature development and website maintenance. Participation in team meetings and code reviews.",
    skills: ["JavaScript", "HTML/CSS", "PHP", "MySQL", "Git"]
  },
  {
    year: "2017 - 2019",
    title: "Web Development Student",
    company: "Digital School",
    description: "Intensive training in modern web technologies. Practical projects and company internships.",
    skills: ["HTML/CSS", "JavaScript", "Python", "SQL", "UI/UX"]
  }
];
